...
class BrandingTests(unittest.TestCase):
    ...
    def test_responsive_sections_replace_fixed_width_form(self):
        ...
        self.assertIn("Fluent.Card", advanced)
        self.assertNotIn("Fluent.Expander", advanced)
        self.assertIn('objectName: "codexTaskNavigation"', view)
        self.assertIn('objectName: "codexCompactTaskNavigation"', view)
        self.assertIn('objectName: "codexSectionStack"', view)
        self.assertIn("currentIndex: root.selectedSection", view)
    ...
    def test_startup_splash_uses_engine_owned_instance(self):
        ...
        self.assertIn('app.attach_startup_window(window_instance)', main_py)
...
"""
    ...
    def test_release_version_and_macos_disclosure_are_consistent(self):
        ...
        release_notes = self.read("docs/release-notes/v1.0.28.md")
